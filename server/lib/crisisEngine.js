...
export function scenarioSignal(input = {}) {
  const scenarios = {
    ...
    brand: {
      source: 'reddit',
      title: 'Brand statement criticized across community channels',
      location: 'Jakarta',
      lat: -6.208,
      lng: 106.845,
      ...
      sentiment: -82,
      reach: 1240000,
      summary: 'Audience screenshots and community posts criticize a brand statement for tone, timing, and cultural context.',
    },
    supply: {
      source: 'rss',
      title: 'Regional delivery delay cluster affects essential goods',
      location: 'Surabaya',
      lat: -7.257,
      lng: 112.752,
      ...
      sentiment: -49,
      reach: 540000,
      summary: 'RSS logistics bulletins and merchant reports show a delivery delay cluster affecting priority inventory routes.',
    },
  }
